...
public class AvailableTest {
  ...
  public void testIsAvailable()  throws IOException {
    ...
    Assert.assertTrue("File exists but was not found.", new Available(project).setFileC(sourceFile).eval());
  }  
  ...
  public void testNotAvailable() throws IOException {
    ...
    Assert.assertFalse("File doesn't exist but was found.", new Available(project).setFileC(sourceFile).eval());
  }  
